...
- File: `/home/jnsougata/Projects/discohook/discohook/guild.py`
...
```python
create_emoji(self, name: str, image: str, *, roles: List[str] | None = None, reason: str | None = None)
```
...
```python
create_role(self, name: str, *, permissions: List[discohook.permission.Permission] | None = None, color: int = 0, hoist: bool = False, mentionable: bool | None = False, icon_data_uri: str | None = None, unicode_emoji: str | None = None, reason: str | None = None)
```

#### `edit_channel_position`

```python
edit_channel_position(self, channel_id: str, *, position: int, lock_permissions: bool = False, parent_id: str | None = None)
```
...
```python
fetch_channels(self) -> List[discohook.channel.Channel]
```
...
```python
fetch_member(self, user_id: str) -> discohook.member.Member | None
```
...
```python
fetch_roles(self) -> List[discohook.role.Role]
```
